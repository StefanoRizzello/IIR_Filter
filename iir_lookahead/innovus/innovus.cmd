...
#  Created on Thu Nov 18 00:08:00 2021                
#                                                     
#######################################################
...
setDrawView fplan
win
dumpToGIF snapshot/ss_iir_filter_snapshot.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF snapshot/ss_iir_filter_snapshot.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF snapshot/ss_iir_filter_snapshot.place.gif
checkPlace checkplace.ss.rpt
dumpToGIF screenCapture/iir_filter_screenCapture
win
reset_parasitics
extractRC
...
encMessage debug 0
encMessage info 0
restoreDesign iir_filter.enc.dat iir_filter
setDrawView fplan
...
read_activity_file -format VCD -scope /tb_iir/UUT -start {} -end {} -block {} ../vcd/iir_filter_postplace.vcd
set_power -reset
